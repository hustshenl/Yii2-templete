...
use Yii;
use admin\models\access\Assignment;
use admin\models\access\SignupForm;
use admin\models\access\searchs\Assignment as AssignmentSearch;
...
class AssignmentController extends Controller
{
    ...
    public function actionUpdate($id){
        $model = $this->findUpdateAdminForm($id);
        //var_dump($model);exit;
